...
public class GideonState : GameState
{
    Unit player;

    public override void Enter()
    {
        Debug.Log("Entered Gideon state");
        if (owner.gameType == 1)
        {
        ...
        Debug.Log("Gideon has " + player.actions + " actions " + player.movement + " movement");
        ...
        owner.gameUI.transform.GetChild(0).GetChild(6).GetComponent<TMPro.TextMeshProUGUI>().text = player.MaxMovemment.ToString();
